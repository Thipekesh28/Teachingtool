...
<section class="playlist-details">
   ...
   <h1 class="heading">Video For Test Caes</h1>
   ...
   <div class="row">
      ...
      <div class="column">
         ...
         <div class="details">
            <h3>RYU Basic Usage</h3>
            <p>How to start the ryu controller</p>
...
<section class="playlist-videos">
   ...
   <h1 class="heading">RYU Basic Usage</h1>
   ...
   <div class="box-container">
      ...
      <a class="box" href="watch-video.php">
         ...
         <img src="images/firewall.png" alt="">
         <h3>Complete  tutorial (part 01)</h3>
      </a>
<!--
      <a class="box" href="watch-video.php">
         <i class="fas fa-play"></i>
