...
<section class="form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>update name</p>
      <input type="text" name="name" placeholder="Thipekesh" maxlength="50" class="box">
      <p>update email</p>
      <input type="email" name="email" placeholder="thipekesh@gmail.come" maxlength="50" class="box">
